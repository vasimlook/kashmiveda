                ...
                <div class="card card-bordered card-preview col-md-6 col-12">
                    <div class="card-inner">
                        ...
                        <div class="preview-block">
                            <form method="POST" action="<?= url_to('admin_product_add') ?>" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="number" name="price" step="0.01" class="form-control" placeholder="Enter Your Price" value="<?= old('price')?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="level_1_commission" step="0.01" class="form-control" placeholder="0.00" value="<?= old('level_1_commission')?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="level_2_commission" step="0.01" class="form-control" placeholder="0.00" value="<?= old('level_2_commission')?>">
                                            <div class="input-group-append"><span class="input-group-text">%</span></div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="level_3_commission" step="0.01" class="form-control" placeholder="0.00" value="<?= old('level_3_commission')?>">
                                            <div class="input-group-append"><span class="input-group-text">%</span></div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="Active" name="status" class="custom-control-input" value="active" <?= old('status') == 'active' ? 'checked' : 'checked' ?>/>
                                                <label class="custom-control-label" for="Active">Active</label>
                                            </div>
                                            &nbsp;&nbsp;
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="Inactive" name="status" class="custom-control-input" value="inactive" <?= old('status') == 'inactive' ? 'checked' : '' ?>/>
