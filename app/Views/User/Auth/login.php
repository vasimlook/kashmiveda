                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        ...
                        <div class="card card-bordered">
                            <div class="card-inner card-inner-lg">
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Access the User panel using your phone and passcode.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <?php endif; ?>
                                <form method="POST" action="<?= url_to('user_login_process') ?>">
                                    <?= csrf_field() ?>
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            ...
                                            <a class="link link-primary link-sm" href="<?= url_to('user_forgot_password') ?>">Forgot Code?</a>
                                        </div>
                                        <div class="form-control-wrap">
                                ...
                                <div class="form-note-s2 text-center pt-4"> New on our platform? <a href="<?= url_to('user_register') ?>">Create an account</a></div>
                            </div>
                        </div>
                    </div>
