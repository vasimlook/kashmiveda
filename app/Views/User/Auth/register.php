...
<head>
    ...
    <title>User Register | <?= APP_NAME ?></title>
    <!-- StyleSheets  -->
                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        ...
                        <div class="card card-bordered">
                            <div class="card-inner card-inner-lg">
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Access the User panel using your email and passcode.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <?php endif; ?>
                                <form method="POST" action="<?= url_to('user_register_process') ?>">
                                    <?= csrf_field() ?>
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control form-control-lg" id="default-01" placeholder="Enter your name" name="name" value="<?= old('name') ?>" autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control form-control-lg" id="default-01" placeholder="Enter your phone no" name="phone" value="<?= old('phone') ?>">
                                ...
                                <div class="form-note-s2 text-center pt-4"> Already have an account? <a href="<?= url_to('user_login')?>" class="text-primary"><strong>Sign in</strong></a>
                                </div>
                            </div>
                        </div>
                    </div>
